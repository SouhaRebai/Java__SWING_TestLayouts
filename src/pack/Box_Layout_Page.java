...
public class Box_Layout_Page extends JFrame{
	...
	public Box_Layout_Page(){
		...
		pan.add(validateBut);
		pan.add(map);
		validateBut.setSize(new Dimension (700,720));
		//preferred size does not work 
		pan.add(validateBut);
		this.setVisible(true);
	}
public static void main(String[] args) {
	Box_Layout_Page testFrame = new Box_Layout_Page();
}
}
